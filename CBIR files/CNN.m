function [precision, recall, cmat] = CNN1(numOfReturnedImgs, dataset, queryImageFeatureVector, metric)
...
%# classify using one-against-one approach,  with 3rd degree poly kernel
